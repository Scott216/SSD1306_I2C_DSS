...
class Adafruit_SSD1306 : public Adafruit_GFX {
 public:
  ...
  Adafruit_SSD1306(int8_t RST, uint32_t timeout);
 ...
 private:
  uint8_t _i2caddr;  // adafruit's version this was changed to int8_t, but this caused ambigious error for with I2C.h library
  int8_t rst;
